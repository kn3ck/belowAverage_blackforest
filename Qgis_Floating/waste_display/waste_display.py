...
class FloatingWaste:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FloatingWaste_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&FloatingWaste')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('FloatingWaste', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/waste_display/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'WasteStatus'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&FloatingWaste'),
                action)
            self.iface.removeToolBarIcon(action)

    def getWasteClass(wastecount):
        wasteclass = None
        if wastecount >= 30:
            wasteclass = 2
        elif wastecount >=10:
